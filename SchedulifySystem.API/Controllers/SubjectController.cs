...
namespace SchedulifySystem.API.Controllers
{
    ...
    public class SubjectController : BaseController
    {
        ...
        [HttpGet]
        [Authorize]
        public Task<IActionResult> GetSubjectListWithSchoolId(int schoolId, string? subjectName, bool includeDeleted = false, int pageIndex = 1, int pageSize = 20)
        {
            return ValidateAndExecute(()=> _subjectService.GetSubjectBySchoolId(schoolId, subjectName, includeDeleted, pageSize, pageIndex));
        }
