...
namespace SchedulifySystem.Service.Services.Interfaces
{
    public interface ISubjectService
    {
        ...
        Task<BaseResponseModel> CreateSubjectList(List<SubjectAddListModel> subjectAddModel);// need update subject group
        Task<BaseResponseModel> GetSubjectBySchoolId(string? subjectName, bool? isRequired, bool includeDeleted, int pageSize, int pageIndex);
