...
namespace SchedulifySystem.Service.Services.Interfaces
{
    public interface IRoomSubjectService
    {
        ...
        public Task<BaseResponseModel> DeleteRoomSubject(int schoolId, int id);
        public Task<BaseResponseModel> UpdateRoomSubject(int schoolId, int id, RoomSubjectUpdateModel model);
