...
namespace SchedulifySystem.Service.Utils.Constants
{
    public static class ConstantResponse
    {
        ...
        public const string TIMETABLE_EXIST_PUBLISH = "Trong 1 học kì chỉ có 1 thời khóa biểu được áp dụng trong 1 thời điểm.";
        ...
        public const string TIMETABLE_NOT_EXIST_IN_THIS_TIME = "Khoảng thời gian này không có thời khóa biểu nào được áp dụng.";
        ...
        public const string ADD_PROVINCE_SUCCESS = "Thêm tỉnh thành công.";
        public const string REMOVE_PROVINCE_SUCCESS = "Xóa tỉnh thành công.";
        public const string UPDATE_PROVINCE_SUCCESS = "Cập nhật tỉnh thành công.";
